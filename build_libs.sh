...
my_base_modules="account b2bua contact cons ctrl_tcp debug_cmd echo httpd menu mwi netroam natpmp presence ice stun turn serreg uuid stdio"
my_audio_modules="alsa aubridge aufile ausine mixminus"
